...
const services = [
  {
    ...
    desc: 'Ancient Filipino healing massage using oils and skilled hands to restore energy flow.',
    tag: 'Most Popular',
    color: '#fef3c7',
    accent: '#d97706',
  },
  {
    ...
    desc: 'Warm herbal bundle massage that soothes sore muscles and relieves tension.',
    tag: 'Best for Pain',
    color: '#dcfce7',
    accent: '#16a34a',
  },
  {
    ...
    desc: 'Focused pressure techniques on the head, neck, and shoulders for deep relaxation.',
    tag: 'Stress Relief',
    color: '#ede9fe',
    accent: '#7c3aed',
  },
  {
    ...
    desc: 'Traditional pressure-point therapy on the feet to heal the whole body.',
    tag: 'Walk-in',
    color: '#fce7f3',
    accent: '#db2777',
  },
  {
    ...
    desc: 'Deep-tissue massage with warm coconut or essential oils for full-body relief.',
    tag: 'New',
    color: '#ffedd5',
    accent: '#ea580c',
  },
  {
    icon: '🧘',
    title: 'Whole-Body Hilot',
    desc: 'Full-body session combining multiple hilot techniques for total wellness.',
    tag: 'Premium',
    color: '#e0f2fe',
    accent: '#0284c7',
  },
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hl-hero {
          position: relative;
          overflow: hidden;
          background: linear-gradient(145deg, #0f172a 0%, #1c1408 55%, #2d1a04 100%);
        ...
        .hl-hero::before {
          ...
          inset: 0;
          background:
            radial-gradient(ellipse 70% 60% at 50% 110%, rgba(217,119,6,0.22) 0%, transparent 70%),
            radial-gradient(circle at 85% 15%, rgba(251,191,36,0.08) 0%, transparent 50%),
            radial-gradient(circle at 10% 80%, rgba(14,165,233,0.07) 0%, transparent 40%);
          pointer-events: none;
        }

        /* Subtle bamboo-like texture lines */
        .hl-hero::after {
          content: '';
          position: absolute;
          inset: 0;
        ...
        /* ── CONTACT ── */
        .hl-contact {
          background: linear-gradient(145deg, #0f172a 0%, #1c1408 100%);
          padding: 80px 40px;
          position: relative;
          overflow: hidden;
      ...
      <div className="hl-home">
        ...
        <section className="hl-hero">
          <div className="hl-hero-pill">
            <span /> Now accepting new patients
          </div>
          ...
          <div className="hl-hero-btns">
            <button className="hl-btn-primary" onClick={() => navigate('/book')}>
              Book a Session
            </button>
            <button className="hl-btn-outline" onClick={() => navigate('/appointments')}>
              My Appointments
            </button>
          </div>
        </section>
        ...
        <section className="hl-section">
          <div className="hl-section-header">
            ...
            <p>Each session is guided by experienced hilot practitioners using generations-old techniques.</p>
          </div>
          ...
          <div className="hl-services-grid">
            {services.map((svc, i) => (
              ...
              >
                <div className="hl-card-icon-wrap" style={{ background: svc.color }}>
                  {svc.icon}
                </div>
                <div className="hl-card-tag" style={{ background: svc.color, color: svc.accent }}>
                  {svc.tag}
                </div>
                <h3>{svc.title}</h3>
                <p>{svc.desc}</p>
                <button className="hl-card-btn" style={{ color: svc.accent }}>
                  Book Now →
                </button>
                <div style={{
                  position: 'absolute', bottom: 0, left: 0, right: 0,
                  height: 3, background: svc.accent,
          ...
          <div className="hl-contact-inner">
            ...
            <div className="hl-contact-grid">
              <div className="hl-contact-card">
                ...
                <h4>Phone</h4>
                <p>+63 XXX XXX XXXX<span>Main line</span></p>
              </div>
              <div className="hl-contact-card">
                <div className="hl-contact-icon">📍</div>
                <h4>Address</h4>
                <p>123 Clinic Street<span>City, Province, Philippines</span></p>
              </div>
              <div className="hl-contact-card">
                <div className="hl-contact-icon">✉️</div>
                <h4>Email</h4>
                <p>hello@heallots.com<span>We reply within 24 hours</span></p>
              </div>
              <div className="hl-contact-card">
                <div className="hl-contact-icon">🕐</div>
                <h4>Operating Hours</h4>
                <p>Mon – Sat: 8AM – 6PM<span>Sunday: Closed</span></p>
              </div>
            </div>
          </div>
        </section>
